...
DEFAULT_KEYMAP = (
    ...
    {'context': 'torrentlist', 'key': 's p', 'action': 'sort --add path',
     'description': 'Sort torrents by download path'},
    {'context': 'torrentlist', 'key': 's P', 'action': 'sort --add !path',
    ...
    {'context': 'peerlist', 'key': 's h', 'action': 'sort --add host',
     'description': 'Sort torrents by hostname/IP'},
    {'context': 'peerlist', 'key': 's H', 'action': 'sort --add !host',
     'description': 'Sort torrents by hostname/IP in reverse'},
    ...
    {'context': 'peerlist', 'key': 's n', 'action': 'sort --add torrent',
    ...
    {'context': 'trackerlist', 'key': 's n',   'action': 'sort --add torrent',
