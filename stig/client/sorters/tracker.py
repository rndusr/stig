...
class TrackerSorter(SorterBase):
    ...
    SORTSPECS = {
        ...
        'downloads':       _SortSpec(lambda t: t['count-downloads'],
                                     aliases=('dns',),
                                     description='number of known finished downloads'),
        ...
        'last-announce':   _SortSpec(lambda t: t['time-last-announce'],
                                     aliases=('lan',),
                                     description='last time the torrent was announced'),
        'next-announce':   _SortSpec(lambda t: t['time-next-announce'],
                                     aliases=('nan',),
                                     description='next time the torrent will be announced'),
        'last-scrape':     _SortSpec(lambda t: t['time-last-scrape'],
                                     aliases=('lsc',),
                                     description='last time the torrent was scraped'),
